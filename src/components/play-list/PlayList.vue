...
export default {
    ...
    computed:{
        modeText(){
            return  this.mode_getter === playMode.sequence ? '顺序播放' : this.mode === playMode.random ?
            '随机播放' : '单曲循环'
            
        },
        ...mapGetters(['playlist_getter','sequenceList_getter','currentSong','mode_getter'])
    },
    methods:{
        show(){
            this.showFlag = true
        ...
        selectItem(item,index){
            if(this.mode_getter === playMode.random){
                index = this.playlist_getter.findIndex( (song) => {
        ...
        scrollToCurrent(current){
            const index = this.sequenceList_getter.findIndex( (song) => {
        ...
        deleteOne(item){
            ...
            if(!this.playlist_getter.length){
                this.hide()
            }
        },
        showConfirm(){
